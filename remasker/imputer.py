...
def main():
    ...
    #%%
    """model load"""
    model_name = f"ReMasker_{config['dataset']}_{config['missing_type']}_{config['missing_rate']}"
    ...
    #%%
    """imputation"""
    imputed = model.impute(train_dataset, config, device)
